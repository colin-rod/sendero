...
export const trailSummaries: TrailSummary[] = [
  ...
  },
  {
    ...
    distance: 15.0,
    duration: '~1h',
    thumbnail: 'https://placehold.co/800x600/e2b71f/1b1b1b?text=El+Sendero+del+Cafe',
    comingSoon: true,
    priority: 2,
  },
  {
    ...
    name: 'El Sendero del Páramo',
    difficulty: 'Moderate',
    distance: 28.0,
    duration: '~2h',
    thumbnail: 'https://placehold.co/800x600/e2b71f/1b1b1b?text=El+Sendero+del+Paramo',
    comingSoon: true,
    priority: 3,
  },
];
